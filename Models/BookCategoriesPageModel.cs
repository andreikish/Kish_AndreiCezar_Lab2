...
namespace Kish_AndreiCezar_Lab2.Models
{
public class BookCategoriesPageModel : PageModel
{
    public List<AssignedCategoryData> AssignedCategoryDataList;
    public void PopulateAssignedCategoryData(Kish_AndreiCezar_Lab2Context context,
    Book book)
    {
    ...
    public void UpdateBookCategories(Kish_AndreiCezar_Lab2Context context,
